...
export function FundingRealityCheck() {
  ...
  return <main className="terminal-shell">
    ...
    <section className="principle-band"><p><span>Perp Verdict</span> makes the costs visible before a headline yield becomes a story.</p><a href="#method">Read the calculation <Icon type="arrow" /></a></section>
